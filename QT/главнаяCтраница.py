...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, root=True):
        ...
        self.pushButton_8.clicked.connect(functools.partial(self.Confirmation, 'Вы действительно хотите удалить товар из аукциона? (при удалении товара произойдёт списания 5% от текущей стоимости товара )'))
        self.pushButton_9.clicked.connect(functools.partial(self.Confirmation, 'Вы действительно хотите удалить данный товар из списка'))
        self.pushButton_10.clicked.connect(functools.partial(self.Confirmation, 'Вы действительно хотите удалить все товары которые не участвуют на аукционе ?'))
