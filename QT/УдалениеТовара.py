...
class Ui_Dialog(object):
    def __init__(self, n, t, u, main_window): # n - текст всплывающий в сплывающем окне; t - индекс товара по выделенной ячейки; u - номер нажатой кнопки 
        self.n = n
        self.t = t[0]
        self.u = u
    ...
    def OK (self):
        db.add_delete(self.t, self.u)  # t - индекс товара по выделенной ячейки; u - номер нажатой кнопки     
